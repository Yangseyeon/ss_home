						...
						<div class="card bg-dark text-white" style="border-radius: 1rem;">
							<div class="card-body p-5 text-center">
								...
								<div class="mb-md-5 mt-md-4 pb-5">
									...
									<h2 class="fw-bold text-white mb-2 text-uppercase">회원가입</h2>
									<p class="text-white-50 mb-5"></p>
									<form method="POST" action="<%= root %>/member?action=regist">
										...
										<div class="form-outline form-white mb-4">
											...
											<input type="password" name="password" id="typeEmailX"
												class="form-control form-control-lg" required /> <label
												class="form-label" for="typeEmailX"> </label>
										</div>

										<div class="form-outline form-white mb-4">
											<div class="text-start">이름</div>
										...
										<div class="form-outline form-white mb-4">
											<div class="text-start">주소</div>
											<input type="text" name="address" id="typeEmailX"
												class="form-control form-control-lg" /> <label
												class="form-label" for="typeEmailX"> </label>
										</div>

										<div class="form-outline form-white mb-4">
											<div class="text-start">전화번호</div>
											<input type="tel" name="phoneNumber" id="typePasswordX"
												class="form-control form-control-lg" /> <label
												class="form-label" for="typePasswordX"></label>
										</div>

										<input href="<%= root %>/member?action=signup"
